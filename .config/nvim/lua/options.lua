...
opt.wildmenu = true; -- cmdline completion menu
opt.wildoptions = { 'pum', 'tagfile' }; -- cmdline completion
opt.completeopt = { 'menuone', 'noselect', 'noinsert', 'preview' }; -- completion menu
...
opt.sidescrolloff = 12; -- start scrolling this many columns from edge
